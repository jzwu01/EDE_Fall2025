...
```{r echo=FALSE, fig.align='left', fig.cap="2018 monthly Ozone levels", fig.height=4, fig.width=8, message=FALSE, warning=FALSE}
library(cowplot)
year18 <- epa_data %>%
  filter(Year == "2018") %>%
  ...
  geom_boxplot() +
  ylim(0, 100) +
  labs(title = "Monthly Ozone concentrations (2018)", x = "Month", y = expression("Concentration (µg/m"^3*")"))
print(year18)

```

```{r echo=FALSE, fig.align='left', fig.cap="2019 monthly Ozone levels", fig.height=4, fig.width=8, message=FALSE, warning=FALSE}
library(cowplot)
year19 <- epa_data %>%
  filter(Year == "2019") %>%
  ggplot(aes(x = factor(Month, levels = 1:12, labels = month.abb),
  ...
  geom_boxplot() +
  ylim(0, 100) +
  labs(title = "Monthly Ozone concentrations (2019)", x = "Month", y = expression("Concentration (µg/m"^3*")"))
print(year19)
```
...
## Git Repository
https://github.com/jzwu01/EDE_Fall2025
