...
ntl_1999 <- filter(NTL.phys.data, year4 == 1999)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
tuesday_90s <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 >= 1990, year4 <= 1999)
...
ntl_month <- mutate(NTL.phys.data, month = month(sampledate))
class(ntl_month$month)


ntl_tuesday_90s_july <- 
  ntl_month %>% 
