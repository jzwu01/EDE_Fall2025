...
```{r}
#Exercise 1:
ozoneplot1 <- ggplot(EPAair, aes(x = Ozone,
                                 fill = as.factor(Year))) +
  geom_density(alpha = 0.5)+
  scale_fill_manual(values = c('darkgreen', 'darkblue'))
  labs(title = "Density Plot: Ozone by year", x = "Ozone AQI Value", y = "Density",
       fill = " ")
print(ozoneplot1)
...
pm25.ozone.regression <- lm(EPAair$PM2.5 ~
                            EPAair$Ozone)
...
pm25byozone <- ggplot(EPAair, aes(x = Ozone, y = PM2.5))+
